                        ...
                        <div class="ed-pagination">
                            <ul class="pagination" v-if="pagination.last_page > 1">
                                ...
                                <li :class="(pagination.current_page == n)?'active':''"
                                    v-for="n in pagination.last_page" :key="n" class="page-item"><a class="page-link"
                                        @click="getResults(pagination.path_page + n)">{{n}}</a></li>
                                <li v-if="pagination.current_page != pagination.last_page" class="page-item"><a
                                        class="page-link" @click="getResults(pagination.last_link)">Next</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
